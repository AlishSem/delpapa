            ...
            <>
                <Navbar dark expand="md">
                    <div className="container">
                        <NavbarBrand href="/"> <img src="assets/images/logo.png" height="30" width = "41" alt="Del Papa"/></NavbarBrand>
                    ...
                    <div className="container">
                        <div className='row row-header'>
                            <div className='col-12 col-sm-6'>
                                <h1>Del Papa</h1>
                                <p> We take inspiration from the worlds best cuisienes, in order to create unique experience</p>
                            </div>
                        </div>
                    </div>
                </Jumbotron>
